...
const modelJsonFields: Array<{
  ...
  },
  {
    ...
    labelKey: 'Per-second multipliers',
    descriptionKey:
      'JSON map of model to resolution multipliers for per-second video billing.',
  },
]
        ...
        {editMode === 'visual' ? (
          <div className='space-y-6'>
            <ModelRatioVisualEditor
              ...
              savedPerSecondMultipliers={savedValues.PerSecondMultipliers}
