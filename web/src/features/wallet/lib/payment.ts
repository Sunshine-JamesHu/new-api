...
/**
 * Check if a payment method points to the official Alipay provider.
 */
export function isOfficialAlipayPayment(
  paymentType: string,
  provider?: string
): boolean {
  return paymentType === PAYMENT_TYPES.ALIPAY && provider === 'alipay'
}
