	...
	anonymousRequestBodyLimit := middleware.AnonymousRequestBodyLimit()
	{
		...
		userRoute := apiRouter.Group("/user")
		{
			...
			selfRoute.Use(middleware.UserAuth())
			{
				...
				selfRoute.GET("/invoice/titles", controller.GetInvoiceTitles)
				selfRoute.POST("/invoice/titles", controller.CreateInvoiceTitle)
				selfRoute.PUT("/invoice/titles/:id", controller.UpdateInvoiceTitle)
				selfRoute.DELETE("/invoice/titles/:id", controller.DeleteInvoiceTitle)
				selfRoute.GET("/invoice/orders", controller.GetInvoiceOrders)
				selfRoute.GET("/invoice/applications", controller.GetInvoiceApplications)
				selfRoute.GET("/invoice/applications/:id", controller.GetInvoiceApplicationDetail)
				selfRoute.POST("/invoice/applications", middleware.CriticalRateLimit(), controller.CreateInvoiceApplication)
			...
			adminRoute.Use(middleware.AdminAuth())
			{
				...
				adminRoute.POST("/topup/invoice", controller.AdminUpdateTopUpInvoice)
				adminRoute.GET("/invoice", controller.GetAdminInvoiceApplications)
				adminRoute.GET("/invoice/template", controller.GetInvoiceTemplate)
				adminRoute.PUT("/invoice/template", controller.UpdateInvoiceTemplate)
				adminRoute.GET("/invoice/:id", func(c *gin.Context) { c.Set("is_admin", true); controller.GetInvoiceApplicationDetail(c) })
				adminRoute.POST("/invoice/:id/issue", middleware.CriticalRateLimit(), controller.IssueInvoice)
